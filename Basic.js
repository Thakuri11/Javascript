...
//DOM [Document Object Model]    used to access and modify html and css through js

//searching the DOM

//1.querySelector [ Apply background color to first elements with class "dom" ]

document.querySelector(".dom").style.backgroundColor = "green";

//2.querySelectorAll [ Apply background color to all elements with specified class name ...it returns html collection so we must use loop to apply changes on all]

document.querySelectorAll(".dom").forEach(e => {e.style.backgroundColor = "green"});

//3.getElementById   [Select the elements with sepecified id name]
